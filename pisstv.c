...
// Note: Compile me thus:  gcc -lgd -lm -lmagic -o pisstv pisstv.c
// You need also the debian-packages libmagic-dev libgd2-noxpm-dev
...
// ================
#define MODE 3
//Scottie 1 = 0; Scottie 2 = 1; Scottie DX = 2; Martin 1 = 3; Martin 2 = 4; Robot 36 = 5; Robot 72 = 6; Pasokon 3 = 7; Pasokon 5 = 8; Pasokon 7 = 9;
//PD 50 = 10; PD 90 = 11; PD 120 = 12; PD 160 = 13; PD 180 = 14; PD 240 = 15; PD 290 = 16;
...
void addvisheader()
{
    uint16_t vis[17]={60,56,76,44,40,8,12,113,114,115,93,99,95,98,96,97,94};    int visbin[8];	//
    int visbuffer = 0; 	//
    int i = 0;
    ...
    while(visbuffer != 0)
	{
        	 ...
        	 visbin[i++]= visbuffer % 2;

         	 visbuffer = visbuffer / 2;
...
//  playtone( 1500 , 300000 ) ;
    ...
    playtone( visbin[0] ,  30000 ) ;
    playtone( visbin[1] ,  30000 ) ;
    playtone( visbin[2] ,  30000 ) ;
    playtone( visbin[3] ,  30000 ) ;
    playtone( visbin[4] ,  30000 ) ;
    playtone( visbin[5] ,  30000 ) ;
    playtone( visbin[6],  30000 ) ;
    playtone( visbin[7] ,  30000 ) ; 
